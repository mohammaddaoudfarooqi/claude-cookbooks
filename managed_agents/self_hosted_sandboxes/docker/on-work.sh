...
# MONGODB_URI (optional) is YOUR database secret, not Anthropic's — forwarded into the
...
# rather than the raw URI. Unset MONGODB_URI is passed through as empty (a no-op). See README.
